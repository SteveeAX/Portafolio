...
function AppContent() {
  ...
  const getBlogHref = () => {
    ...
    if (hostname === 'steveenquiroz.vercel.app') {
      return `https://steveenquiroz.vercel.app/blog${langQuery}`;
    }
  ...
  const homepageTitle = 'Portafolio | Steveen Quiroz';
  const homepageSeoTitle = isSpanish
    ? 'Ingeniero en Telemática'
    : 'Telematic Engineer';
  const homepageDescription = isSpanish
    ? 'Portafolio de Steveen Quiroz, Ingeniero en Telemática de Cuenca, Ecuador. Especializado en IoT, análisis de datos, Machine Learning e IA.'
    : 'Portfolio of Steveen Quiroz, Telematic Engineer from Cuenca, Ecuador. Specialized in IoT, data analysis, Machine Learning and AI.';
  const homepageKeywords = isSpanish
    ? [...DEFAULT_KEYWORDS, 'ingeniero telemática', 'IoT Ecuador', 'machine learning Ecuador']
    : [...DEFAULT_KEYWORDS, 'telematic engineer', 'IoT developer', 'machine learning engineer'];
