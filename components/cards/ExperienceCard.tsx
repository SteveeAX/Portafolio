  ...
  return (
    <div className="mt-auto space-y-2 sm:space-y-4">
      <div className="flex items-center gap-2.5 sm:gap-4 group">
        ...
        <div>
          <p className="font-black text-sm sm:text-base md:text-lg leading-none mb-0.5 sm:mb-1 text-primary">{first.company}</p>
          <p className="text-text-muted text-[9px] sm:text-[10px] md:text-xs font-semibold uppercase tracking-wide">{first.role}</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2.5 sm:gap-4 opacity-50 hover:opacity-100 transition-opacity">
        ...
        <div>
          <p className="text-text-main font-bold text-sm sm:text-base md:text-lg leading-none mb-0.5 sm:mb-1">{second.company}</p>
          <p className="text-text-muted text-[9px] sm:text-[10px] md:text-xs font-semibold uppercase tracking-wide">{second.role}</p>
        </div>
      </div>
    </div>
  );
