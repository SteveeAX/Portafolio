...
export const translations = {
  en: {
    ...
    introBio: 'Building <scalable>technological solutions</scalable> that help solve <performance>real problems</performance>.',
    ...
    systemsEngineering: 'Telematic Engineering',
    technologicalUniversity: 'Technical State University of Quevedo',
    ...
    bio: 'Bio',
    bioText: 'I am a Telematic Engineer specialized in IoT and data analysis. My goal is to transform data into technological solutions that create a positive impact. Based in Cuenca, Ecuador.',
    ...
    skill1: 'IoT Systems Design',
    skill2: 'Data Analysis & Processing',
    skill3: 'Application Development',
    skill4: 'Machine Learning & AI',

    // Stack Modal
    technicalArsenal: 'Tech Stack',
    technicalArsenalDesc: 'A selection of the technologies I use to build real-world solutions across software, AI, cloud, and embedded systems.',
    stackLangs: 'Programming Languages',
  ...
  es: {
    ...
    introBio: 'Construyendo <scalable>soluciones tecnológicas</scalable> que ayuden a resolver <performance>problemas reales</performance>.',
    ...
    systemsEngineering: 'Ingeniería en Telemática',
    technologicalUniversity: 'Universidad Técnica Estatal de Quevedo',
    ...
    bio: 'Biografía',
    bioText: 'Soy un Ingeniero en Telemática especializado en IoT y análisis de datos. Mi objetivo es transformar datos en soluciones tecnológicas que impacten positivamente. Resido en Cuenca, Ecuador.',
    ...
    // About — Habilidades Clave
    keySkillsTitle: 'Habilidades Clave',
    skill1: 'Diseño de sistemas IoT',
    skill2: 'Análisis y procesamiento de datos',
    skill3: 'Desarrollo de aplicaciones',
    skill4: 'Machine Learning e IA',

    // Stack Modal
    technicalArsenal: 'Stack Técnico',
    technicalArsenalDesc: 'Las tecnologías que uso para construir soluciones reales en software, IA, cloud y sistemas embebidos.',
    stackLangs: 'Lenguajes de Programación',
    stackCloud: 'Cloud & IoT',
